...
public class ReportController {
    ...
    public Result getBusinessReportData(){
        try{
           ...
           /* map.put("flag",true);
            map.put("message","获取运营统计数据成功");
            Map map2 = new HashMap();
            map2.put("reportDate","");
            List list = new ArrayList();
            Map map3 = new HashMap();
            map3.put("name","阳光爸妈升级肿瘤12项筛查（男女单人）体检套餐");
            map3.put("setmeal_count",10);
            map3.put("proportion",0.24);
            list.add(map3);
            map2.put("hotSetmeal" ,list);
            map.put("reportData",map2);
            return map;*/
